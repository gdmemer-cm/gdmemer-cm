...
<body>
 ...
 <h2>2. Команды</h2>
    <h3>Команды GDMmer CM</h3>
    <ol>
        <h3>Модераторские</h3>
        <li>/warn ID – выдать предложение</li>
        <li>/ban ID – заблокировать пользователя</li>
        <li>/mute ID – заглушить пользователя</li>
        <li>/setrank ID число – выдать пользователю указанный ранг</li>
        <li>/warnlimit число – указать число предупреждений при достижении лимита которых, пользователь будет заблокирован</li>
        <li>/admin ID – назначить пользователя администратором</li>
        <li>/setrules текст – установить правила в чате</li>
